    ...
    const handleLogin = async (e) => {
        ...
        try {
            ...
            if (token) {
                ...
                localStorage.setItem('userId', userData.id || userData._id || userData.user_id || '');
                localStorage.setItem('userName', userData.nickname || userData.name || '사용자');
                localStorage.setItem('studentId', userData.student_number || userData.studentId || '학번 미설정');
                localStorage.setItem('userDept', userData.major || userData.department || '컴퓨터공학과');
